...
public:
    ...
    void setupUi(QWidget *PersonalInfoManage)
    {
        ...
        IDEdit->setGeometry(QRect(490, 280, 211, 31));
        label = new QLabel(PersonalInfoManage);
        label->setObjectName("label");
        label->setGeometry(QRect(440, 290, 51, 20));
        label_2 = new QLabel(PersonalInfoManage);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(460, 250, 40, 12));
        emailEdit = new QLineEdit(PersonalInfoManage);
        emailEdit->setObjectName("emailEdit");
        emailEdit->setGeometry(QRect(490, 240, 211, 31));
        label_3 = new QLabel(PersonalInfoManage);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(460, 210, 40, 12));
        phoneEdit = new QLineEdit(PersonalInfoManage);
        phoneEdit->setObjectName("phoneEdit");
        phoneEdit->setGeometry(QRect(490, 200, 211, 31));
        label_4 = new QLabel(PersonalInfoManage);
        label_4->setObjectName("label_4");
        label_4->setGeometry(QRect(460, 170, 40, 12));
        dateEdit = new QLineEdit(PersonalInfoManage);
        dateEdit->setObjectName("dateEdit");
        dateEdit->setGeometry(QRect(490, 160, 211, 31));
        label_5 = new QLabel(PersonalInfoManage);
        label_5->setObjectName("label_5");
        label_5->setGeometry(QRect(460, 130, 40, 12));
        nameEdit = new QLineEdit(PersonalInfoManage);
        nameEdit->setObjectName("nameEdit");
        nameEdit->setGeometry(QRect(490, 120, 211, 31));
        avatarLabel = new QLabel(PersonalInfoManage);
        avatarLabel->setObjectName("avatarLabel");
        avatarLabel->setGeometry(QRect(210, 40, 161, 231));
        uploadButton = new QPushButton(PersonalInfoManage);
        uploadButton->setObjectName("uploadButton");
        uploadButton->setGeometry(QRect(260, 290, 56, 18));
    ...
    void retranslateUi(QWidget *PersonalInfoManage)
    {
        ...
        avatarLabel->setText(QCoreApplication::translate("PersonalInfoManage", "TextLabel", nullptr));
        uploadButton->setText(QCoreApplication::translate("PersonalInfoManage", "\344\270\212\344\274\240\345\233\276\347\211\207", nullptr));
    } // retranslateUi
